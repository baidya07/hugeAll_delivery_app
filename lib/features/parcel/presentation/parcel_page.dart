  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Container(
          padding:
              const EdgeInsets.symmetric(horizontal: SC.mW, vertical: SC.sH),
          ...
          child: Row(
            children: [
              ...
              const SecondaryDropDown(items: <String>[
                '12:00 - 1:00 am',
                '1:00 - 2:00 am',
                '2:00 - 3:00 am',
                '3:00 - 4:00 am',
      ...
      children: [
        FixedTimeline(
          children: [
            ...
            Container(
                child: const _TransferWidget(
              iconImage: 'delivered_icon.svg',
              title: 'Pickup',
              address: 'Jana Milap Galli, Vinayak Tole, Chabahail, Kathmandu',
            )),
            SBC.xxLH,
            const _TransferWidget(
              iconImage: 'drop_icon.svg',
              title: 'Drop Point',
              address: 'Newroad, Opposite NIC bank, Sundhara',
            ),
          ],
        )
      ],
          ...
          Column(
            ...
            children: [
              Text(
                title,
                style:
                    Theme.of(context).textTheme.caption!.copyWith(height: 1.5),
              ),
              SBC.mH,
              Text(
                address,
                style: Theme.of(context)
                    .textTheme
                    .bodyText2!
                    .copyWith(height: 1.5, fontSize: 10),
              ),
            ],
          )
        ],
